...
const items = [
  ...
  { id: "applianceset", title: "리유스 가전 세트(중고, 3~6점)", base: "中古家電セット 冷蔵庫 洗濯機 電子レンジ 炊飯器 ケトル", category: "appliance",
    priority: "첫 주", minBudget: 39800, mode: ["week1"], setItems: ["fridge", "washer", "microwave", "ricecooker", "kettle", "vacuum"],
    note: "혼자 자취 가전은 중고 리유스 세트가 가장 저렴합니다(도쿄권 배송·설치 무료, 보증 있는 매장). 3단 = 세트 크기입니다 — 최저가=3점(냉장고+세탁기+전자레인지), 중간=5점(+밥솥+청소기), 프리미엄=6점(+밥솥+전기포트+청소기). ★추천은 모두 트레팩(送料·설치 무료). 배송에 며칠~1주 걸리니 7/28 입주 전 도착시키려면 이번 주(~7/21경) 주문 권장. 아래 '세트 구성'에서 각 품목을 개별로도 살 수 있습니다(세트를 안 살 때 대안). 신뢰 매장: トレファク(트레팩), 楽天 パワーセラー, リユース家電Happy, いいね家電.",
    picks: {
      budget: { name: "트레팩 중고 3점 세트(냉장고+세탁기+레인지, 배송·설치 무료)", price: 39800, rating: "4.41", reviews: "758", url: "https://item.rakuten.co.jp/trefac-f/999005/" },
      mid: { name: "트레팩 중고 5점 세트(+밥솥+청소기)", price: 48300, rating: "4.44", reviews: "39", url: "https://item.rakuten.co.jp/trefac-f/999053/" },
      premium: { name: "트레팩 중고 6점 세트(+밥솥+전기포트+청소기)", price: 49800, rating: "4.55", reviews: "74", url: "https://item.rakuten.co.jp/trefac-f/999052/" } } },
  ...
  { id: "ricecooker", title: "밥솥", base: "炊飯器 3合", category: "appliance",
    priority: "첫 주", minBudget: 6000, mode: ["week1"], inSet: "applianceset",
  ...
  { id: "kettle", title: "전기포트", base: "電気ケトル", category: "appliance",
    priority: "당일", minBudget: 2000, mode: ["day1"], inSet: "applianceset",
